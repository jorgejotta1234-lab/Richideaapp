...
import { Wallet, TrendingUp, ArrowUpRight, ArrowDownLeft, ShieldCheck, History, Lightbulb, Star, Share2, MessageSquare, DollarSign, Camera, User } from 'lucide-react';
...
const Dashboard: React.FC = () => {
  ...
  const [ratingTx, setRatingTx] = useState<any>(null);
